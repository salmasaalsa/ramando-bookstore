                                ...
                                <li>
                                    <form action="{{route('product_attr.store')}}" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="size" value="1" id="size" placeholder="Size" required>
                            ...
                            <form action="{{route('product_attr.update',$product->id)}}" method="post" role="form">
                                ...
                                <tr>
                                    <td class="taskDesc">
                                        ...
                                        <input type="hidden" name="size[]" id="size" class="form-control" value="1" required="required" style="width: 75px;">
