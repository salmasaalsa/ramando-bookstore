        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="{{asset('shoppers/index.html')}}" class="js-logo-clone">shopperss</a>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  ...
                  <li>
                    <a href="{{asset('shoppers/cart.html')}}" class="site-cart">
        ...
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            <li class="has-children active">
              <a href="{{asset('shoppers/index.html')}}">Home</a>
              <ul class="dropdown">
            ...
            <li class="has-children">
              <a href="{{asset('shoppers/about.html')}}">About</a>
              <ul class="dropdown">
                <li><a href="#">Menu One</a></li>
                <li><a href="#">Menu Two</a></li>
                <li><a href="#">Menu Three</a></li>
            ...
            <li><a href="{{asset('shoppers/shop.html')}}">Shop</a></li>
            <li><a href="#">Catalogue</a></li>
            <li><a href="#">New Arrivals</a></li>
            <li><a href="{{asset('shoppers/contact.html')}}">Contact</a></li>
          </ul>
        </div>
      </nav>
    </header>

    <div class="site-blocks-cover" style="background-image: url({{url('shoppers/images/hero_1.jpg')}});" data-aos="fade">
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="nonloop-block-3 owl-carousel">
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{asset('shoppers/images/cloth_1.jpg')}}" alt="Image placeholder" class="img-fluid">
                  </figure>
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{asset('shoppers/images/shoe_1.jpg')}}" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{asset('shoppers/images/cloth_2.jpg')}}" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{asset('shoppers/images/cloth_3.jpg')}}" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
