...
class CartController extends Controller
{
    ...
    {
        $this->middleware('FrontLogin_middleware');
    }
    ...
    public function addToCart(Request $request){
        ...
        //echo $inputToCart['size'];
        if($inputToCart['size']==""){
            return back()->with('message','Please select Size');
        }else{
            $stockAvailable=DB::table('product_att')->select('sku','stock')->where(['products_id'=>$inputToCart['products_id'],
